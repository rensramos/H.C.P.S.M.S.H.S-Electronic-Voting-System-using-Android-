...
<body>
    ...
    <div id="bodycontainer">
    	<div id="studbodybar">
        	<div id="bodytext">EDITING STUDENT</div>
        </div>  	
    		<div id="studbodyruler"></div>
    	<div id="bodycontent">
        	<?php include('../include/edit_Stud.php'); ?>
            <div id="ssglogostudentedit"></div>
    	</div><!-- body content-->
    </div><!-- body container-->
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sStud', 'Successfully Updated!', 2000);";
