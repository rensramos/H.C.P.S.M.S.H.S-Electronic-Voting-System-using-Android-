...
<body>
    ...
    <div id="bodycontainer">
    	<div id="adbodybar">
        	<div id="bodytext">CHANGE PASSWORD</div>
        </div>  	
    		<div id="adbodyruler"></div>
    	<div id="bodycontent">

        	<?php include('../include/edit_Password.php'); ?>
            <div id="ssglogoadminpass"></div>
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sAdmin', 'Password Change!', 2000);";
