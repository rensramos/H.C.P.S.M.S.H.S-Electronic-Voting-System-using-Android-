...
<body>
    ...
    <div id="canbodybar">
        <div id="bodytext">REGISTRATION OF CANDIDATE</div>
    </div>  	
    <div id="canbodyruler"></div>
    <div id="bodycontent">
        <?php include('../include/add_Candi.php'); ?>
         <div  id="ssglogocandidate"></div>	
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sCandi', 'Successfully registered!', 2000);";
