...
import com.evoting.Auditor.LoadComments;
...
public class Auditor extends ListActivity{
	...
	private static final String CANDIDATES_URL = "http://192.168.1.225/Electrovots/Android/auditor.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String auditor = preferences.getString(cAuditor, "None");
		String id = preferences.getString(cAuditorID, "00");
    	...
    	position.setText("Auditor");
    	
    	isConnected = true;
    	
    	if(baudit){
    		submit.setVisibility(View.VISIBLE);
    		cName.setText(auditor);
    		cID.setText(id);
    	}
	}
	...
	private void updateList() {
		...
		SimpleAdapter adapter = 
				new SimpleAdapter(Auditor.this, mCandidateList, R.layout.position_content, 
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					...
					//This is for testing
					/*Toast toast = Toast.makeText(Auditor.this, "hello"+name.getText().toString(), Toast.LENGTH_SHORT);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Auditor.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (isConnected == false){
				Toast toast = Toast.makeText(Auditor.this, "Cannot connect to Server!",Toast.LENGTH_LONG);
				toast.setGravity(Gravity.CENTER, 0, 0);
				toast.show();
			}
			else{
	...
	public void submit(View v){
		...
		edit.putString(cAuditor, cName.getText().toString());
		edit.putString(cAuditorID, cID.getText().toString());
		edit.putBoolean(cAuditorSelected, true);
		edit.putBoolean(cVote_StraightSelected, false);
		edit.commit();
		
		String a=preferences.getString("cAuditor", "");
		String b=preferences.getString("cAuditorID", "");
	    ...
	    //This is for testing
		/*Toast toast = Toast.makeText(Auditor.this, a+b, Toast.LENGTH_SHORT);
		toast.setGravity(Gravity.CENTER, 0, 0);
		toast.show();*/
	}
