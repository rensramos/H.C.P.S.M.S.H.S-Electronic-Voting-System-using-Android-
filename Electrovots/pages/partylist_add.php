...
<body>
    ...
    <div id="bodycontainer">
        <div id="partybodybar">
        	<div id="bodytext">REGISTRATION OF PARTYLIST</div>
        </div>  	
        <div id="partybodyruler"></div>
        <div id="bodycontent">
            <?php include('../include/add_Party.php'); ?>
            <div  id="ssglogoparty"></div>	
        </div><!-- body content-->
    </div><!-- body container-->
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sParty', 'Successfully registered!', 2000);";
