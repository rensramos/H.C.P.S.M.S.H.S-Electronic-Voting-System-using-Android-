...
<body>
    ...
    <div id="bodycontainer">
    	<div id="canbodybar">
        	<div id="bodytext">EDITING CANDIDATE</div>
        </div>  	
    		<div id="canbodyruler"></div>
    	<div id="bodycontent">
        <div id="ssglogo"></div>
        	<?php include('../include/edit_Candi.php');?>
              <div id="ssglogocandidateedit"></div>
    	</div><!-- body content-->
    </div><!-- body container-->
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sCandi', 'Successfully Updated!', 2000);";
