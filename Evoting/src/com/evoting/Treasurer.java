...
import com.evoting.Treasurer.LoadComments;
...
public class Treasurer extends ListActivity{
	...
	private static final String CANDIDATES_URL = "http://192.168.1.225/Electrovots/Android/treasurer.php";
	...
	private void updateList() {
		...
		SimpleAdapter adapter = 
				new SimpleAdapter(Treasurer.this, mCandidateList, R.layout.position_content, 
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					...
					//This is for testing
					/*Toast toast = Toast.makeText(Treasurer.this, "hello"+name.getText().toString(), Toast.LENGTH_SHORT);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Treasurer.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (isConnected == false){
				Toast toast = Toast.makeText(Treasurer.this, "Cannot connect to Server!",Toast.LENGTH_LONG);
				toast.setGravity(Gravity.CENTER, 0, 0);
				toast.show();
			}
			else{
	...
	public void submit(View v){
		...
		String a=preferences.getString("cTreasurer", "");
		String b=preferences.getString("cTreasurerID", "");
	    ...
	    //This is for testing
		/*Toast toast = Toast.makeText(Treasurer.this, a+b, Toast.LENGTH_SHORT);
		toast.setGravity(Gravity.CENTER, 0, 0);
		toast.show();*/
	}
