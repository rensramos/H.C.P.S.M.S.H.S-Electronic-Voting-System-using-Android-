...
import com.evoting.Peace_Officer.LoadComments;
...
public class Peace_Officer extends ListActivity{
	...
	private static final String CANDIDATES_URL = "http://192.168.1.225/Electrovots/Android/peace_officer.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String peace_officer = preferences.getString(cPeace_Officer, "None");
		String id = preferences.getString(cPeace_OfficerID, "00");
    	...
    	position.setText("Peace Officer");
    	
    	isConnected = true;
    	
    	if(bpo){
    		submit.setVisibility(View.VISIBLE);
    		cName.setText(peace_officer);
    		cID.setText(id);
    	}
	}
	...
	private void updateList() {
		...
		SimpleAdapter adapter = 
				new SimpleAdapter(Peace_Officer.this, mCandidateList, R.layout.position_content, 
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					...
					//This is for testing
					/*Toast toast = Toast.makeText(Peace_Officer.this, "hello"+name.getText().toString(), Toast.LENGTH_SHORT);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Peace_Officer.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (isConnected == false){
				Toast toast = Toast.makeText(Peace_Officer.this, "Cannot connect to Server!",Toast.LENGTH_LONG);
				toast.setGravity(Gravity.CENTER, 0, 0);
				toast.show();
			}
			else{
	...
	public void submit(View v){
		...
		edit.putString(cPeace_Officer, cName.getText().toString());
		edit.putString(cPeace_OfficerID, cID.getText().toString());
		edit.putBoolean(cPeace_OfficerSelected, true);
		edit.putBoolean(cVote_StraightSelected, false);
		edit.commit();
		
		String a=preferences.getString("cPeace_Officer", "");
		String b=preferences.getString("cPeace_OfficerID", "");
	    ...
	    //This is for testing
		/*Toast toast = Toast.makeText(Peace_Officer.this, a+b, Toast.LENGTH_SHORT);
		toast.setGravity(Gravity.CENTER, 0, 0);
		toast.show();*/
	}
