...
<body>
    ...
    <div id="bodycontainer">
    	<div id="partybodybar">
        	<div id="bodytext">EDITING PARTYLIST</div>
        </div>  	
    	<div id="partybodyruler"></div>
    	<div id="bodycontent">
        	<?php include('../include/edit_Party.php'); ?>
            <div id="ssglogopartyedit"></div>
    	</div><!-- body content-->
    </div><!-- body container-->
    ...
    <script>
		...
		if(!empty($_POST)){
			if($message==1){
				echo"displayNotification('sParty', 'Successfully Updated!', 2000);";
				echo"e.preventDefault();";
			}
			else{
				echo"displayNotification('fAll', '...Failed!', 2000);";
				echo"e.preventDefault();";
			}
		}
		?>
