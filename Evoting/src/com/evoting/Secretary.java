...
import com.evoting.Secretary.LoadComments;
...
public class Secretary extends ListActivity{
	...
	private static final String CANDIDATES_URL = "http://192.168.1.225/Electrovots/Android/secretary.php";
	...
	private void updateList() {
		...
		SimpleAdapter adapter = 
				new SimpleAdapter(Secretary.this, mCandidateList, R.layout.position_content, 
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					...
					//This is for testing
					/*Toast toast = Toast.makeText(Secretary.this, "hello"+name.getText().toString(), Toast.LENGTH_SHORT);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Secretary.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (isConnected == false){
				Toast toast = Toast.makeText(Secretary.this, "Cannot connect to Server!",Toast.LENGTH_LONG);
				toast.setGravity(Gravity.CENTER, 0, 0);
				toast.show();
			}
			else{
	...
	public void submit(View v){
		...
		String a=preferences.getString("cSecretary", "");
		String b=preferences.getString("cSecretaryID", "");
	    ...
	    //This is for testing
		/*Toast toast = Toast.makeText(Secretary.this, a+b, Toast.LENGTH_SHORT);
		toast.setGravity(Gravity.CENTER, 0, 0);
		toast.show();*/
	}
